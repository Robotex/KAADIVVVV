...
if (typeof exportFunction === 'function') {
  ...
  window.eval('Object.defineProperty(window, \'jhecatdjh\', { value: window.vvvvid.models.PlayerObj.prototype.checkAdv, writable: false })');
  ...
  Object.defineProperty(window, 'jhecatdjh', { value: window.vvvvid.models.PlayerObj.prototype.checkAdv, writable: false });
